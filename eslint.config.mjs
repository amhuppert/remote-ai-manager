...
const MIGRATED_UTILITY_FIRST = [
  ...
  "src/components/conversation/CheckpointPanel.stories.tsx",
  "src/components/conversation/CheckpointStatusChip.tsx",
  "src/components/conversation/CheckpointStatusChip.stories.tsx",
  "src/components/conversation/ConversationCheckpointControls.tsx",
  "src/components/conversation/checkpoint-story-fixtures.tsx",
  ...
  // Notepad surfaces: utility-first component directory. Mirrors the
  // .prettierrc class-sort override and the tailwind-utility-collisions
  // UTILITY_FIRST_PATHS allowlist.
