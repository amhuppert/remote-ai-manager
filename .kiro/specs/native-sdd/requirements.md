...
5. When a draft is proposed, the spec system shall classify every element as unchanged, modified, or removed; approvals on unchanged elements shall carry forward automatically, approvals on modified elements shall become stale with the element-level change shown side by side for re-approval, and approvals on removed elements shall be closed.
