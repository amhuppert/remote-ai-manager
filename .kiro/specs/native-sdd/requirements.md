...
11. Citation rows, citation snapshots, citation version, citation contract version, and citation hash shall be mutable only while their owning revision is a draft. Proposed, approved, and withdrawn revisions shall remain frozen through service and repository guards backed by database triggers.
