...
- [x] 1. Add unit tests for shared components
- [x] 1.1 Test ConfirmDialog rendering and interactions
...
- [x] 2. Add unit tests for project list components
- [x] 2.1 Test ProjectCard rendering
...
- [x] 3. Add unit tests for session list components
- [x] 3.1 Test SessionsList rendering
...
- [x] 3.2 (P) Test CreateSessionModal
...
- [x] 4. Add unit tests for session detail components
- [x] 4.1 Test SessionDetailPage message rendering
...
- [x] 4.3 (P) Test prompt input behavior
...
- [x] 5. Add project archive data layer
- [x] 5.1 (P) Extend state schema and add archive helper functions
...
- [x] 5.2 Write unit tests for archive state helpers
...
- [x] 6. (P) Create CardContextMenu shared component
...
- [x] 7. (P) Create archive API endpoint
...
- [x] 8. (P) Update ProjectCard for context menu and archive display
...
- [x] 9. Build ProjectsGridClient with search, filters, and archive toggle
- [x] 9.1 Build search input with real-time name filtering
...
- [x] 9.2 Add status filter pills with counts
...
- [x] 9.3 Add archive toggle and integrate archive API
...
- [x] 9.4 Combine all filters with no-results state and single-menu enforcement
...
- [x] 10. Integrate ProjectsGridClient into the projects page
...
- [x] 11. Add tests for new features
- [x] 11.1 (P) Test CardContextMenu interactions
...
- [x] 11.2 (P) Test archive API endpoint
...
- [x] 11.3 (P) Test ProjectsGridClient filter logic
