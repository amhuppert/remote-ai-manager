...
| -------------------------------------- | ------------------------------------------------------------------ | ------------------------------------------------------- | --------------------------------------------------------------------- | --------------------------------------------------------- |
| Single CSS file with custom properties | Current approach: all tokens and component styles in `globals.css` | Simple, no build tooling, direct mapping to design spec | Could grow unwieldy for very large projects                           | Appropriate for CC project scale                         |
