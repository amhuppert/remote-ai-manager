...
- [ ] 1. Add unit tests for parseDiff edge cases
- [ ] 1.1 (P) Test metadata line skipping
...
- [ ] 1.2 (P) Test addition/deletion counting accuracy
...
- [ ] 1.3 (P) Test file ordering preservation
  - Verify files appear in the output in the same order as the git diff
  - Verify hunks within a file appear in order
  - _Requirements: 3.4_

- [ ] 2. Add integration tests for computeDiff
- [ ] 2.1 Test successful diff computation
...
- [ ] 2.2 (P) Test git failure handling
...
- [ ] 2.3 (P) Test empty diff output
  - Mock `execFile` to return an empty string
  - Verify an empty diff is returned
  - _Requirements: 1.5_

- [ ] 3. Add rendering tests for DiffPanel
- [ ] 3.1 Test file section rendering
...
- [ ] 3.3 (P) Test navigation controls
