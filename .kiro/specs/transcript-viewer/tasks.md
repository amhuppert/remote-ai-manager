...
- [ ] 1. Add unit tests for extractContent edge cases
- [ ] 1.1 (P) Test string content trimming
...
- [ ] 1.2 (P) Test content block array with all non-text blocks
...
- [ ] 1.3 (P) Test message.role fallback
...
- [ ] 2. Add rendering tests for SessionDetailPage
- [ ] 2.1 Test message rendering with role and content
...
- [ ] 2.2 Test empty state rendering
