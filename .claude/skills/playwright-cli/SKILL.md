---
name: playwright-cli
description: Automate a browser with playwright-cli for interactions, visual checks, debugging, or Playwright test authoring.
allowed-tools: Bash(playwright-cli:*) Bash(cctl:*) Bash(npx:*) Bash(bun:*)
---
