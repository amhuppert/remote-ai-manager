...
Done when every finding is dispositioned and each disposition carries its own reason — none accepted on the reviewer's authority alone, none rejected without a grounded reason.
