...
export function useSessionPageViewProps(
  ...
  const panelContainerProps: PanelContainerProps = {
    ...
    selectedBackend: backendModelSelection.selectedBackend,
  ...
  return {
    ...
    promptInputSlotProps: {
      ...
      agentBackend: backendModelSelection.selectedBackend,
      promptComposerProps,
    },
...
function useComposerProps(
  ...
  return usePromptComposerProps({
    ...
    backendLocked: backendModelSelection.backendLocked,
    selectedBackend: backendModelSelection.selectedBackend,
    handleBackendChange: backendModelSelection.handleBackendChange,
    modelCatalog: backendModelSelection.modelCatalog,
    modelCatalogs: backendModelSelection.modelCatalogs,
    modelSelection: backendModelSelection.modelSelection,
    modelSelectionBlockedReason:
      backendModelSelection.modelSelectionBlockedReason,
    setModelSelection: backendModelSelection.setModelSelection,
