...
function renderStrip(onLayoutChange: (mode: LayoutMode) => void = () => {}) {
...
describe("SessionInfoStrip responsive controls", () => {
  it("changes layout from the Actions fallback", async () => {
    const onLayoutChange = vi.fn();
    const restore = renderStrip(onLayoutChange);
    try {
