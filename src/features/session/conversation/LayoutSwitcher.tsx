...
const LAYOUT_BTN_CLASS =
  "relative flex h-[26px] w-[32px] items-center justify-center rounded-sm border-none bg-transparent p-0 text-text-tertiary transition-all duration-150 ease-[ease] focus-visible:[outline:2px_solid_var(--color-cyan)] focus-visible:outline-offset-2 data-[active=false]:hover:bg-bg-hover data-[active=false]:hover:text-text-secondary data-[active=true]:bg-cyan data-[active=true]:text-text-inverse [&_svg]:h-4 [&_svg]:w-[18px]";
...
export default function LayoutSwitcher({
  ...
  return (
    ...
    >
      {LAYOUT_OPTIONS.map(({ mode, tooltip, icon }) => (
