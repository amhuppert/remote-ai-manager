...
// CC_SMOKE_URL must point at a SessionPage conversation route, e.g.
// http://localhost:3001/projects/<project>/<session>/<conversationId>.
...
describe.skipIf(!shouldRun)(
  "SessionPage Playwright smoke (regular Conversations page)",
  () => {
    let browser: Browser;
    let page: Page;
    ...
    it("renders the SessionPage shell", async () => {
