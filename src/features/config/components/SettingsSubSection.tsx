...
export function SettingsSubSection({
  ...
  return (
    <section className="overflow-hidden rounded-lg border border-solid border-border-subtle bg-bg-surface p-lg max-768:rounded-none max-768:border-x-0 max-768:px-sm">
      ...
      <div className="mt-md flex flex-col gap-md px-[14px] pt-md pb-[14px] max-768:px-xs">
        {children}
      </div>
    </section>
  );
