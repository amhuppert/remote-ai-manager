...
export function buildContextValidationPrompt(
  ...
  return [
    ...
    "- **Respect the operating envelope.** The charter's non-goals bound the criteria. A finding that only arises under a condition the charter lists as a non-goal or outside the envelope is an advisory, never a blocking issue, however faithfully a criterion's wording could be read to cover it.",
