...
export const getRoadmapItems = defaultStore.getRoadmapItems;
export const createRoadmapItem = defaultStore.createRoadmapItem;
export const updateRoadmapItem = defaultStore.updateRoadmapItem;
export const deleteRoadmapItem = defaultStore.deleteRoadmapItem;
