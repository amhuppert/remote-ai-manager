...
const UTILITY_FIRST_PATHS = [
  ...
  `${path.sep}components${path.sep}conversation${path.sep}ConversationCheckpointControls.tsx`,
  `${path.sep}components${path.sep}conversation${path.sep}checkpoint-story-fixtures.tsx`,
