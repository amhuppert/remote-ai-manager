 ...
 * job path the same promptness. Read-path reconciliation (published-merge lookup on status reads) remains the designed
 * backstop, and the implementation is idempotent by
 * (execution, mergeHash).
 */
...
export function notifyMergeDelivered(
