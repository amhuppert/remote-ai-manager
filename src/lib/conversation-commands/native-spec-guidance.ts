...
export const SPEC_GUIDANCE_SECTIONS: readonly SpecGuidanceSection[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      "only human sign-off advances the draft. Every preset begins at requirements;",
      "advancing concludes that checkpoint and opens a separate design draft.",
      "",
  ...
  },
  {
    ...
    lines: [
      ...
      "--reason <why>`; the server withdraws the design attempt and opens from the",
      "latest approved requirements checkpoint without copying unapproved design choices backward. Approved",
  ...
  },
  {
    ...
    lines: [
      ...
      "definition's `acceptanceCriteria[].covers`; write binding dispositions only",
      "with `cctl spec plan edit <slug> --file <plan.json>`. Native",
      "SDD has no alternate graph shape.",
      "",
      ...
      'what would refuse a propose — is owned by the "Delivering a native',
      ...
      "",
      "`binding` supplies a total disposition for each pinned criterion. Proposal",
