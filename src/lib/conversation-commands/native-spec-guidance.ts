...
export const SPEC_GUIDANCE_SECTIONS: readonly SpecGuidanceSection[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      'author into its managed workflow is the "Delivering a native spec"',
      "section of the graph-workflow-planning skill, and each receipt on that",
      "path names the act that follows it.",
    ],
  },
  {
    id: "amendments",
  ...
  },
  {
    ...
    lines: [
      ...
      "`schemaVersion: 3` plan document; `cctl spec plan get <slug>` is the",
      ...
      "omitting the fields the server stamps. Criterion dispositions and claims",
      "are written with `cctl spec plan edit <slug> --file <plan.json>`. Native",
      ...
      'spec" section of the graph-workflow-planning skill. Every receipt on this',
