 ...
 * message or followed by whitespace plus optional hint text (mirrors
 * `hasCollabPrefix` semantics). Returns null for non-command text, including
 * near-misses like `/committed` and mid-message occurrences.
 */
