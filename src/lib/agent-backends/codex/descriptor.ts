...
export const codexBackendMetadata: AgentBackendMetadata = {
  ...
  models: [
    ...
    codexModel("gpt-6-sol", "GPT-6 Sol", "Flagship"),
    codexModel("gpt-6-luna", "GPT-6 Luna", "Fast & affordable"),
    codexModel("gpt-5.6-sol", "GPT-5.6 Sol", "Previous flagship"),
    codexModel("gpt-5.6-terra", "GPT-5.6 Terra", "Balanced"),
    codexModel("gpt-5.6-luna", "GPT-5.6 Luna", "Previous fast model"),
    codexModel("gpt-5.5", "GPT-5.5", "Older flagship"),
