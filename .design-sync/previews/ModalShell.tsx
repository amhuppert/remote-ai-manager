...
import * as S from "@ds-stories/src/components/ui/ModalShell.stories";

// Owned preview. ModalShell renders a `position:fixed` centered modal (overlay +
...
// fully visible. The modal keeps its real fixed/centered behavior — only its
// viewport is given height.
...
export const Confirm = wrap(compose(S, "Confirm"));
export const LayoutPlacement = wrap(compose(S, "LayoutPlacement"));
