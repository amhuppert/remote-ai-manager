---
description: This skill should be used when diagnosing CC issues, analyzing
  failures, tracing user actions through logs, investigating hook problems,
  state corruption, prompt execution errors, or understanding what happened in
  recent runs. Use when asked to "check logs", "debug", "what went wrong",
  "trace request", "find errors", or "analyze recent activity".
name: debug-logs
---
